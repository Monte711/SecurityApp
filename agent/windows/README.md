...
- **Умное определение Windows**: Интеллектуальная логика определения версии Windows по номеру билда
...
Агент использует современную логику определения версии Windows на основе номера билда:
...
| Версия | Диапазон билдов | Примеры |
|--------|----------------|---------|
| **Windows 10** | 10240 - 19045 | 10240 (1507), 19041 (2004), 19045 (21H2) |
| **Windows 11** | 22000+ | 22000 (21H2), 22621 (22H2), 26100 (24H2) |

### Формат отображения:
- **Старый формат**: `"Windows 10 Pro"`
- **Новый формат**: `"Windows 10 Pro (Build 19045)"`

### Обработка неизвестных билдов:
- Неизвестные билды логируются для будущих обновлений
- Формат: `"Windows (Build XXXXX)"`
- Создается issue для добавления поддержки нового билда
...
- Имя хоста
- **Версия ОС с умным определением**: Windows 10/11 по номеру билда + точный номер билда
